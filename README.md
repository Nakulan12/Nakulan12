...
<div align="center">
  ...
  <div style="padding: 30px; border-radius: 20px; background: linear-gradient(to right, #0A66C2, #003366); box-shadow: 0px 0px 20px rgba(0,0,0,0.3); display: inline-block;">
    ...
    <p style="font-size: 20px; color: white; font-family: 'Fira Code', monospace; margin-top: 10px; animation: fadeIn 2s ease-in-out infinite alternate;">You're awesome for stopping by 💙</p>
  </div>
</div>
